...
/*   Updated: 2024/04/28 14:02:35 by aelomari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	send_to_b(s_var *var)
{
	...
	{
		if(get_size(var->head_b) >= 2 && var->head_a->index > pivot_1 && var->head_b->index >rem && var->head_b->index < pivot_2)
		rr(&var->head_a, &var->head_b);
		else if(get_size(var->head_b) >= 2 && var->head_b->index > rem && var->head_b->index < pivot_2)
		rb(&var->head_b);
